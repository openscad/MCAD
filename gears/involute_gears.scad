                                 ...
                                 involute_facets)
{
    ...
    {
        for (i = [1:res]) {
            assign(point1 = involute(base_radius * 2,
                   ...
                   point2 = involute(base_radius * 2,
                                     start_angle + (stop_angle - start_angle) *
                                                       (i) / res))
            {
                assign(side1_point1 = rotate_2dvector(centre_angle, point1),
                       side1_point2 = rotate_2dvector(centre_angle, point2),
                       side2_point1 = mirror_2dvector(
                           rotate_2dvector(centre_angle, point1)),
                       side2_point2 = mirror_2dvector(
                           rotate_2dvector(centre_angle, point2)))
                {
                    polyhedron(
                        points =
            ...
            internal = false)
{
    ...
    backlash_angle =
        (internal ? -backlash : backlash) / pitch_radius * 180 / pi;
    ...
    module flat_gear()
    {
        ...
        module rounding_circles()
        {
            ...
            circle_positions = (internal ? [0:1:number_of_teeth]
                ...
                for (i = circle_positions) {
                    rotate([ 0, 0, (i * 360 / number_of_teeth) ])
                        translate([ path_radius, 0 ]) circle(
                            r = ((360 / number_of_teeth - half_thick_angle) /
                                 360) *
        ...
        if (flat) {
            ...
            difference()
            {
                ...
                translate([ 0, 0, gear_thickness ]) linear_extrude_flat_option(
                    flat = flat,
                    height = (rim_thickness - gear_thickness + 0.1))
                    circle(r = rim_radius);
            }
        }
    }
    ...
    difference()
    {
        ...
        linear_extrude_flat_option(flat = flat,
                                   center = true,
                                   height = (max_thickness + 0.1) * 2) union()
        {
            _circles();
            bore();
        }
                           ...
                           involute_facets)
{
    ...
    pitch_point = involute(base_radius,
