...
//	Clearance: Radial distance between top of tooth on one gear to bottom of gap
// on another.

function pitch_circular2diameter(number_of_teeth, circular_pitch) =
  number_of_teeth * circular_pitch / 180;
function pitch_diametral2diameter(number_of_teeth, diametral_pitch) =
  number_of_teeth / diametral_pitch;
                           ...
                           half_thick_angle)
{
  ...
  pitch_to_root_angle =
    pitch_to_base_angle - involute_intersect_angle(base_radius, root_radius);
...
function involute_intersect_angle(base_radius,
                                  radius) = sqrt(pow(radius / base_radius, 2) -
                                                 1);
