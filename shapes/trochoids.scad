...
color([ 0, 0, 1 ]) translate([ 0, 0, -0.5 ])
  cylinder(h = 1, r = R, center = true);

color([ 0, 1, 0 ]) epitrochoid(R, r, d, n, thickness);
  ...
  translate([ (R + r) * cos(alpha), (R + r) * sin(alpha), -0.5 ])
{
  ...
  {
    cylinder(h = 1, r = r, center = true);
    translate([ -d, 0, 1.5 ]) { cylinder(h = 2.2, r = 0.1, center = true); }
  }
}

translate([ 2 * (abs(R) + abs(r) + abs(d)), 0, 0 ])
{
  color([ 0, 0, 1 ]) translate([ 0, 0, -0.5 ]) difference()
  {
    cylinder(h = 1, r = 1.1 * R, center = true);
    cylinder(h = 1.1, r = R, center = true);
  }

  color([ 0, 1, 0 ]) hypotrochoid(R, r, d, n, thickness);
...
translate([ 0, 14, 0 ]) hypotrochoidLinear(4, 1, 1, 40, 40, 10, 30);
    ...
    polyhedron(
      points =
        [
          [ 0, 0, 0 ],
          [
            (R + r) * cos(dth * i) - d * cos((R + r) / r * dth * i),
            (R + r) * sin(dth * i) - d * sin((R + r) / r * dth * i),
            0
          ],
          [
            (R + r) * cos(dth * (i + 1)) - d * cos((R + r) / r * dth * (i + 1)),
            (R + r) * sin(dth * (i + 1)) - d * sin((R + r) / r * dth * (i + 1)),
            0
          ],
          [ 0, 0, thickness ],
          [
