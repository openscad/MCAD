 ...
 * @param boolean screws If defined then "screws" will be added and when the
 * module is differenced() from something if will have holes for the screws
 * @param number axle_lenght If defined this will draw "backgound" indicator for
 * the main axle
 */
...
#cylinder(r = 1.8 / 2, h = 6, $fn = 6);
                ...
                */
                ...
                translate([ -6, -6, 19.0 ]) { cube([ 12, 6.5, 4 ]); }
            }
            if (axle_lenght > 0) {
