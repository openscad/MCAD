        ...
        translate(pos) rotate(orientation)
        {
            translate([ -mid, -mid, 0 ]) difference()
            {
                ...
                if (lip > 0) {
                    ...
                    translate([ side, side, lip ])
                        cylinder(h = length, r = cutR);
                }
                ...
                color(stepperAluminum)
                {
                    ...
                    {
                        translate(
                            [ -1 * length_mm, -1 * length_mm, -1 * length_mm ])
                            cube(size = [
                                side + 2 * length_mm,
                                side + 2 * length_mm,
                                extrSize + 1 *
            ...
            // Axle
            translate([ 0, 0, extrSize - axleLengthFront ])
                color(stepperAluminum) difference()
            {
                ...
                if (axleFlatDepth > 0)
                    translate([
                        ...
                        -5 * length_mm,
                        -extrSize * length_mm -
                            (axleLengthFront - axleFlatLengthFront)
                    ])
                        cube(size = [
                            5 * length_mm,
                            10 * length_mm,
